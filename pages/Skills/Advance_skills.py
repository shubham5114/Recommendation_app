...
from pages.Pages_style.pages_style import get_skills_css  # ✅ Import the styles
...
def Skills_call():
    ...
    if st.button("Recommend"):
        ...
        for idx, col in enumerate(cols):
            with col:
                st.image(
                    f"pages/Skills/Images/{recommend_images[idx]}"
                )  # Image size controlled by CSS
